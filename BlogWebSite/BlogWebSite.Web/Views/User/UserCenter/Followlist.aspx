<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Followlist.aspx.cs" Inherits="Views_User_UserCenter_Followlist" %>
            ...
            <div class="view-container">
                <div class="left-box">
                    <div class="list-group">
                        ...
                        <a class="list-group-item  active" href="Followlist.aspx">我关注的人</a>
                        ...
                        <asp:ListView ID="ListView1" runat="server"  DataSourceID="SqlDataSource1">
                            <ItemTemplate>
                                <div class="followlist">
                                    ...
                                    <asp:Button ID="BTNoff" runat="server" Text="取消关注" CssClass="btn btn-default"  CommandArgument='<%#Eval("account_id")%>' OnClick="BTNoff_Click" style="float: right;border: 1px solid #999;border-radius: 4px;font-size: 14px;color: #999;width: 90px;margin-top: 25px;background: #fff;text-align: center;" />
                                </div>
                            </ItemTemplate>
                        </asp:ListView>
                    </div>
