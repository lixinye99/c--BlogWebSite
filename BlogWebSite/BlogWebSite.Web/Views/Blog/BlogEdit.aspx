<%@ Page Language="C#" AutoEventWireup="true" CodeFile="BlogEdit.aspx.cs" Inherits="Views_Blog_BlogEdit" %>
...
<body>
    <form id="form1" runat="server">      
        <nav class="navbar navbar-default ">  
            <div class="container">            
                <div class="edit-nav">
                    <a class="Blog-name" href="../Index/Index.aspx">MyBlog</a>
                    <div class="h5 mb-0 text-secondary">写文章</div>                  
                    <div class="div-choose">
                        <asp:Button ID="chooseType" runat="server" Text="发表文章 ▾" class="btn btn-primary dropdown-toggle dropdown-toggle" data-toggle="dropdown"/>
                        <div class="dropdown-menu div-publish">                        
                            ...
                            <asp:Button ID="publish" runat="server" Text="确认发布" class="btn btn-primary btn-block" OnClick="publish_Click"/>
                            </div>                           
                        </div>
                    </div>
                </div> 
